 ...
 * @param options
 */
CTD.prototype.download = function (url, fileURl, successCallback, errorCallback, trustAllHosts, options) {
    //
    var _this = this;
    this.repeat = 0;
    ...
    _this._getUrlFileLength(url, this.options, function (err, len, _options) {
        if (err) {
 ...
 * @private
 */
CTD.prototype._updateInfoAndDownload = function () {
 ...
 */
CTD.prototype.getFileInfo = function(file, cb) {
    var _this = this;
 ...
 * @private
 */
CTD.prototype._onprogress = function (progressEvent) {
 ...
 * @private
 */
CTD.prototype._getUrlFileLength = function (uri, options, cb) {
    //
 ...
 * @private
 */
CTD.prototype._downloadFile = function (cb) {
